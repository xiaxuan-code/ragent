...
public class S3FileStorageService implements FileStorageService {
    ...
    /**
     * 以 MultipartFile 形式上传文件，并走流式预签名上传链路。
     */
    @Override
    @SneakyThrows
    ...
    /**
     * 通过 AWS SDK 原生上传能力写入文件，适用于需要重试保障的场景。
     */
    @Override
    @SneakyThrows
